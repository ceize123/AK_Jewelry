    ...
    <>
      <div id='BeginnerHandCoursePage'>
        ...
        <main>
          ...
          <ParallaxCricle rellax='rellax' text={['歡迎你!', <br/>, 'Andrea 將手把手的帶你一步一步進入珠寶的世界！']}/>
          <ListsWithDiamond className='learnWhat' title='你可以學到...' listName={learnWhat} />
          <ParallaxCricle rellax='rellax' text={['Andrea老師精心編排，', <br/>, '讓沒有美術設計經驗的同學也能快速上手喔！']}/>
          <ListsWithDiamond className='whyChose' title='為什麼選Andrea Ko珠寶教室?' listName={whyChose} />
          <ParallaxCricle rellax='rellax' text='我們非常重視與產業接軌以及學生的設計發想能力，打好軟實力基礎，才能走得更長遠。'/>
          <h3>上完課你可以做到...</h3>
          ...
          <ParallaxCricle rellax='rellaxBelow' text='沒有設計美術的背景，也能完成像這樣的作品，是不是真的很厲害呢！'/>
          ...
          <ParallaxCricle rellax='rellaxBelow' text='坐而言不如起而行！現在開始你的斜槓人生！'/>
